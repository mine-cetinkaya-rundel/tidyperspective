...
#  {#hello-quarto-title data-menu-title="an educator's perspective of the tidyverse" background-image="images/tidyverse-hexes.png" aria-label="Hex logo for nine core tidyverse packages: dplyr, ggplot2, forcasts, tibble, readr, stringr, tidyr, purrr, lubridate."}
...
::: {.column width="40%"}
![](images/paper-tise.png){width="500"}
:::
:::
