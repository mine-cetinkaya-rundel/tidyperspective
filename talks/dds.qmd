...
![](images-dds/icons8-female-teacher-64.png){fig-alt="Female teacher icon"}
...
![](images-dds/icons8-cake-64.png){fig-alt="Cake icon"}
...
![](images-dds/icons8-code-64.png){fig-alt="Code icon"}
...
![](images-dds/icons8-code-R-64.png){fig-alt="Code icon with R logo"}
...
![](images-dds/sets-vs-pieces.png){fig-alt="On one side Lego city sets, on the other size a lego base plate and loose classic Lego pieces."}
